...
parseLog(changeLog)
  .then((version) -> return console.log(symbol.success, "#{version.packageName()}, MAJOR(#{version.versionMajor()}), MINOR(#{version.versionMinor()}), PATCHLEVEL(#{version.versionPatch()}), SERIES(#{version.series()})"))
